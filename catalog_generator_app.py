...
RAW_FOLDER = BASE_DIR / "raw_data"
REPORT_FOLDER = BASE_DIR / "reports"
QR_FOLDER = BASE_DIR / "qr_codes"
RAW_EXPORT_FOLDER = BASE_DIR / "raw_exports"

FILTERS_FILE = BASE_DIR / "filters.xlsx"


# Change after hosting
PUBLIC_URL = (
    "https://optics-catalog.github.io/Optical-Filters-Catalog/reports/"
)
...
<div class="card" style="display: flex;">
    <a class="button" href="../raw_exports/{filter_id}_raw.csv">
        Download raw data
    </a>

    <a class="button" href="../reports/index.html" style="margin-left: auto;">
        Catalog
    </a>
</div>
...
filters = pd.read_excel(FILTERS_FILE, dtype=str)
...
for _, filter_info in filters.iterrows():
    ...
    try:
        metadata, data = read_spectrum_file(raw_file)
        ...
        print(f"  -> Raw file not found. Skipping report.")

    except Exception as e:
        print(f"  -> Error processing {filter_id}: {e}")
